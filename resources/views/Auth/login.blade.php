...
@section('bodi')     
        ...
        <div class="container">
            <div class="row d-flex justify-content-center mt-4">
              <img
                src="../assets/images/Logo-lpum.png"
                alt=""
                style="width: 120px"
            ...
            >
              <div>
                <h1
                  class="fw-bold animate__animated animate__bounce animate__delay-2s"
            ...
            >
              <div class="col-md-5">
                <div
                  class="card shadow-lg animate__animated animate__fadeInDown animate__slow animate__delay-1s"
                >
                  <div class="card-body">
                    <form
                      action="/auth/login"
