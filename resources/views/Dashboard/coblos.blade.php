...
@section('bodi')
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <h2>Jokowi Ahok</h2>
                    <img
                      src="../assets/images/jokowi-ahok.jpg"
                      alt=""
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <h2>Prabowo Sandi</h2>
                    <img
                      src="../assets/images/prabowo-sandi.jpg"
                      alt=""
                      style="width: 400px; border-radius: 5px"
                      class="shadow-sm"
                    />
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <h2>Naruto Sasuke</h2>
                    <img
                      src="../assets/images/naruto-sasuke.jpg"
                      alt=""
                      style="width: 400px; border-radius: 5px"
                      class="shadow-sm"
                    />
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <h2>Naruto Sasuke</h2>
                    <img
                      src="../assets/images/spongbob-patrik.png"
                      alt=""
                      style="width: 400px; border-radius: 5px"
                      class="shadow-sm"
                    />
  ...
  let today = new Date(),
    ...
    nextYear = yyyy + 1,
    dayMonth = "12/22/",
    birthday = dayMonth + yyyy + " 02:04:00";
