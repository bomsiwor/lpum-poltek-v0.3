    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                {{-- Coblosan --}}
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('coblos') }}"
                        aria-expanded="false"><i class="mdi mdi-border-all"></i><span class="hide-menu">Coblos
                            Digital</span></a>
                </li>
                {{-- Hasil --}}
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('hasil') }}"
                        aria-expanded="false"><i class="mdi mdi-face"></i><span class="hide-menu">Hasil
                            Pemilu</span></a>
                </li>
                {{-- Profile --}}
